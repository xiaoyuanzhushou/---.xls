...
import com.example.xiaoyuanzhushou.courseTable.widget.EditDetailFragment
import com.example.xiaoyuanzhushou.courseTable.widget.colorpicker.ColorPickerFragment
import com.example.xiaoyuanzhushou.ui.home.BaseListActivity
import com.google.android.material.button.MaterialButton
import com.microsoft.appcenter.utils.AppCenterLog.error
        ...
        launch {
            ...
            try {
                ...
                if (!viewModel.updateFlag) {
                    setResult(RESULT_OK, Intent().putExtra("course", viewModel.baseBean))
                }
                finish()
            } catch (e: Exception) {
