...
class ScheduleFragment : BaseFragment() {
    ...
    private fun initWeekPanel(data: List<CourseBean>?, day: Int, table: TableBean) {
        ...
        for (i in data.indices) {
            ...
            if (c.color.isEmpty()) {
                c.color =
                    "#${Integer.toHexString(ViewUtils.getCustomizedColor(requireActivity(), c.id % 9))}"
            }
            ...
            if (tv != null) {
                ...
                if (tv.tipVisibility != TipTextView.TIP_VISIBLE && !isOtherWeek) {
                    ...
                    tv.setOnClickListener {
                        MultiCourseFragment.newInstance(week, c.day, c.startNode)
            ...
            textView.setOnClickListener {
                try {
                    ...
                    //TODO: 提示是否要删除异常的数据
                    //Toasty.error(requireActivity().applicationContext, "哎呀>_<差点崩溃了").show()
                }
            }
