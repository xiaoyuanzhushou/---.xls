...
import com.example.tomatoclock.activity.InfoActivity;
import com.example.tomatoclock.activity.ScheduleActivity;
import com.example.tomatoclock.activity.SettingActivity;
import com.example.tomatoclock.util.TimeFormatUtil;
import com.example.tomatoclock.widget.RippleWrapper;
import com.example.tomatoclock.widget.TickProgressBar;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //用ActionBarDrawerToggle实现点击侧滑栏出现菜单选项
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout,
            ...
            public void onDrawerStateChanged(int newState) {
                ...
                if (mMenuItemIDLE != null ) {

                    onOptionsItemSelected(mMenuItemIDLE);
                   mMenuItemIDLE = null;
                }
            }
        };
